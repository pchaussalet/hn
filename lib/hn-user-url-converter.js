/**
 * @module lib/hn-user-url-converter
 * @requires montage/core/converter/converter
 */

var Converter = require("montage/core/converter/converter").Converter;

var HnUserUrlConverter = exports.HnUserUrlConverter = Converter.specialize( /** @lends Converter# */ {
    /**
    ...
    convert: {
        ...
        value: function(input) {
            return "https://news.ycombinator.com/user?id=" + input;
        }
    },
